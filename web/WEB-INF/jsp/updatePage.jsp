...
<div class="row clearfix container-fluid">
    <div class="col-md-12 column">
        <div class="page-header">
            <h1 class="text-center">订单完成情况修改</h1>
        </div>
    </div>
</div>
...
<div class="col-md-6">
    <form class="form-horizontal" action="${pageContext.request.contextPath}/sale/updateOrderStatus" method="post">
        <input type="hidden" name="Order_number" value="${orderStatus.order_number}<%=request.getAttribute("orderStatus_order_number")%>">
            <div class="form-group">
                <label for="Billing_date" class="col-sm-2 control-label">开单日期</label>
                <!--指定 date标记-->
                <div class="col-sm-10">
                    <div class='input-group date' id='datetimepicker2'>
                        <input type='text' name="Billing_date" class="form-control" id="Billing_date" required="required" value="${orderStatus.billing_date}"/>
